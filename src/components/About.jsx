    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6">This Websites include the technologies like HTML , CSS , JavaScript , React , Tailwind CSS in FrontEnd and it is done by a single men and not by team</p>
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">Yash Rajak</span>
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Yash Rajak</h2>
